---
title: 'Art Brief — NPC: Linh (Watercolor Wash)'
---
...
| **§2 Mood: DayService** | "Tender melancholy — barely there" |
| **§4 Color: White = Safety** | Saved state gains warm rim |
| **§4 Color: Canvas Cream = Erasure** | Abandoned state fades to cream |
...
- **Reference**: Traditional Vietnamese watercolour painting, mist over water
...
*End of Art Brief — Linh (Watercolor Wash)*