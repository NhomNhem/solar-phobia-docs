---
title: 'Art Brief — NPC: Minh (Stippled Impasto)'
---
...
| State | Frames | Notes |
|-------|--------|-------|
| Idle (Base) | 4 | Subtle weight — minimal movement |
...
| **§2 Mood: DayService** | "Stubborn, practical — the awkward choice" |
...
- **Reference**: Van Gogh's thick paint application, textured landscape painting
...
*End of Art Brief — Minh (Stippled Impasto)*