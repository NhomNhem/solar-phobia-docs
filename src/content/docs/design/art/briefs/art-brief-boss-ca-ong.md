...
| **Role** | Background boss entity — persistent threat during Night Phase |
...
| **Sprite Type** | Background layer — parallax-ready |
...
- **Reference**: Hokusai's Great Wave (partial forms), Turner's seascapes (atmospheric)
