---
title: 'ADR-0003-v2: Bộ điều khiển người chơi Pattern (2D)'
description: 'Bản dịch tiếng Việt cho ADR-0003-v2: Bộ điều khiển người chơi Pattern (2D).'
---
...
- **phase ban ngày**: 1D X-axis di chuyển (A/D keys, slow walk). Space=Swap, F=Shove.
- **phase ban đêm**: 2D platformer (A/D sprint). Shift=Spirit Dash, Click=Swing, hold=Glide.

## Quyết định

Use **Rigidbody2D** for phase ban đêm. phase ban ngày uses Transform.position on X-axis only.
...
- Story 007-v2: Phase ban ngày Swap + Shove
