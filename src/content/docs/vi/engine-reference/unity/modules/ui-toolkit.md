---
title: 'UI Toolkit Module Tham chiếu'
description: 'Bản dịch tiếng Việt cho UI Toolkit Module Tham chiếu.'
---
...
UI Toolkit is Unity's modern UI hệ thống, recommended over legacy uGUI and IMGUI.
