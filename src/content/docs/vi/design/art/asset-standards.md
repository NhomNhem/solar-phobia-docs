---
title: 'Section 8: Tiêu chuẩn asset — Solar Phobia'
description: 'Bản dịch tiếng Việt cho Section 8: Tiêu chuẩn asset — Solar Phobia.'
---
...
This section defines all technical standards for art asset production and import. All asset pipelines phải respect the visual identity: **watercolour that survived fire** — warm, textured, and human in day; scorched and bare in night.
...
| **Tham chiếu Geometry** | OBJ | Only if FBX unavailable |
...
| Category Prefix | Asset Loại | Example |
|----------------|-----------|---------|
...
|-------------|-------|-------|
| `_day` | Dịch vụ ban ngày | Warm, lush watercolor |
| `_choice` | Khóa lựa chọn | Transition, cracking |
| `_night` | Sinh tồn ban đêm | Charred, reduced |
| `_resolve` | Resolve | Half-standing |
| *(none)* | Universal | Works across all trạng thái |
...
| Asset Loại | Mipmap | Rationale |
|-----------|-------|----------|
| Background tiles | Enabled | Hiệu năng at distance |
...
> **Budget = Hiệu năng × Visual Độ ưu tiên**. If it reads clearly at required distance, use fewer triangles.
...
## 7. Engine-Specific Ràng buộc (Unity 6000.3.11f1)

### Rendering Pipeline

| Setting | Value | Rationale |
|--------|-------|----------|
| **Pipeline** | URP (Universal) | 2D primary, watercolor shader hỗ trợ |
...
| **Wrap Mode** | Repeat | Tiling hỗ trợ |
| **mipmap** | Per-tier rule | See Section 3 |

### UI-Specific Ràng buộc

| Setting | Value | Rationale |
|----------|---------|----------|
| **Canvas Scaler** | Scale With Screen Size | Resolution independence |
| **Tham chiếu Resolution** | 1920×1080 | 16:9 baseline |
...
- [ ] Mipmaps được bật per-tier rules
