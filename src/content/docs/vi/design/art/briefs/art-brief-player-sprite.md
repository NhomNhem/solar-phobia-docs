---
title: 'Brief mỹ thuật — Player Character Sprite'
description: 'Bản dịch tiếng Việt cho Brief mỹ thuật — Player Character Sprite.'
---
...
**System**: Lõi Loop — Bộ điều khiển người chơi  
...
### Physical Build
| Element | Day Phiên bản | Night Phiên bản |
|---------|-------------|----------------|
...
## 6. Tham chiếu Images (For Artist)
...
**Game Designer**: Bộ điều khiển người chơi GDD specifies di chuyển mechanics  
**Technical Artist**: Unity 2D Animation skeleton requirement

> **Note**: The character phải work as a "painted mark" — visible brushstroke, pigment texture, paper grain showing through. This is not clean vector art. Rough edges are intentional.

---

*End of Brief mỹ thuật — Player Sprite (Day/Night)*