---
title: 'Brief mỹ thuật — Environment: Mounds, Shrines, Props'
description: 'Bản dịch tiếng Việt cho Brief mỹ thuật — Environment: Mounds, Shrines, Props.'
---
...
**System**: Điều phối map và spawn, Environment  
...
> **Lõi Principle**: The environment is not scenery — it is the archaeological layer of a choice. Every structure, every surface, every absence tells the story of what was saved and what was burned.
...
| Mound Loại | Asset IDs | Day Visual | Night Visual | Function |
|------------|-----------|------------|--------------|----------|
...
- No visual difference in Day trạng thái
...
**Win Trigger**: Reaching End Shrine + pressing E triggers win trạng thái.
...
| Area Loại | Density | Rationale |
|-----------|---------|-----------|
| Dịch vụ ban ngày | Sparse (3-5/screen) | Space, breath, illusion of safety |
| Khóa lựa chọn | Medium (8-12/screen) | Tightening begins |
| Sinh tồn ban đêm | Dense (15-25/screen) | Clutter = obstacle = horror |
...
| Safe cover | §4: Burnt Sienna = đang hoạt động memory |
| Danger | §4: Ember Orange = đang hoạt động threat |
...
| Mounds | §3: Cover objects with psychological trạng thái |
...
| Dense clutter (Night) = hazard seed | Dense clutter = ngẫu nhiên decoration |
...
- **Tham chiếu**: Vietnamese fishing village photography (interpret, don't replicate)
...
*End of Brief mỹ thuật — Environment*