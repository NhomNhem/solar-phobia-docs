---
title: 'Đặc tả asset — System: Bộ điều khiển người chơi'
description: 'Bản dịch tiếng Việt cho Đặc tả asset — System: Bộ điều khiển người chơi.'
---
...
- Critical: Phải have z-order priority above Tier 4 panic effects
...
**Art Bible Anchors**:
- §2 Mood: Sinh tồn ban đêm has "grain surge" visual element
...
**Visual Description**:  
A similar circle form but now it's darker — Charcoal Black with ember edge glow. The shape is more angular/jagged, reflecting the night trạng thái.
...
**Art Bible Anchors**:
- §7 UI Animation: "Seeping glow" — color bleeds outward on hover/đang hoạt động

**Generation Prompt**:  
"Horizontal progress bar sprite, watercolour fill effect, soft edges like paint flowing, ochre gold for day trạng thái, ember orange for night, game UI element"
...
*End of Bộ điều khiển người chơi Đặc tả asset*